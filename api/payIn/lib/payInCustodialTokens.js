...
import { isBountyPayment, isP2P, isPayableWithCredits, isProxyPayment, isSystemOnly, isWithdrawal } from './is'
...
function getP2PCost (payIn) {
  // proxy and bounty payments are fully noncustodial -- entire cost is P2P
  if (isProxyPayment(payIn) || isBountyPayment(payIn)) {
    return payIn.mcost
  }
