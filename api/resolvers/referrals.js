    ...
    referrals: async (parent, { when, from, to }, { models, me }) => {
      ...
      return await models.$queryRawUnsafe(`
        ...
        json_build_array(
          ...
          json_build_object('name', 'referral sats', 'value', ROUND(COALESCE(SUM(msats_referrals), 0) / 1000)),
          json_build_object('name', 'one day referral sats', 'value', ROUND( COALESCE(SUM(msats_one_day_referrals), 0) / 1000))
        ) AS data
