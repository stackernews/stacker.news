...
export default {
  ...
  Mutation: {
    ...
    toggleLiveComments: async (parent, { disableLiveComments }, { me, models }) => {
      if (!me) {
        throw new GqlAuthenticationError()
      }

      await models.user.update({ where: { id: me.id }, data: { disableLiveComments } })
      return disableLiveComments
    }
  },
