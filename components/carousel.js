...
// the container owns focus (below) so the keydown fires on it directly — no reaching
// past the popup, and the modal shell needs no key-passthrough escape hatch.
