...
export default function PreviewPlugin ({ editorRef, topLevel, name, itemId }) {
  ...
  return (
    ...
    >
      <Text innerClassName={styles.editorContent} topLevel={topLevel} preview name={name} itemId={itemId} />
    </div>
  )
}
