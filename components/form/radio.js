...
import styles from './checkbox.module.css' // shares the check/radio skin (§19.3-c3)

// a true radio group (§19.0-4b): formik-wired on the REAL field; arrow keys
// rove focus AND select (native radio semantics, roving tabindex)
