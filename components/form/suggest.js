...
export function BaseSuggest ({
  ...
  // D3 (§18.0-8): the rb <Dropdown show> shell becomes a plain listbox on the
  // C5 menu chrome — the mentions/D4 shape. Two anchor modes, both rb-parity:
  // caret mode rides dropdownStyle's inline absolute position (search @/~),
  // static mode is a zero-height relative wrapper right after the input (gap 0)
  return (
    <>
