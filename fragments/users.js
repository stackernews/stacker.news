...
mutation setSettings($tipDefault: Int!, $turboTipping: Boolean!, $fiatCurrency: String!, $noteItemSats: Boolean!,
  ...
  $noteForwardedSats: Boolean!, $hideWalletBalance: Boolean!, $nostrCrossposting: Boolean!, $hideIsContributor: Boolean!, $diagnostics: Boolean!) {
  setSettings(tipDefault: $tipDefault, turboTipping: $turboTipping,  fiatCurrency: $fiatCurrency,
    ...
    noteForwardedSats: $noteForwardedSats, hideWalletBalance: $hideWalletBalance, nostrCrossposting: $nostrCrossposting, hideIsContributor: $hideIsContributor, diagnostics: $diagnostics) {
      ...SettingsFields
    }
  }
`
