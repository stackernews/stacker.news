// Bootstrap 5 utility classes consume both `--sn-primary` and the matching
// `--sn-primary-rgb` triplet (e.g. `rgba(var(--sn-primary-rgb), .5)`), so we
...
// Returns "r, g, b" suitable for `rgba(var(--sn-primary-rgb), .5)`.
