...
export function injectComment (cache, newComment, { live = false, rootId } = {}) {
  ...
  if (updated || (live && !hasComments)) {
    ...
    updateAncestorsCommentCount(cache, ancestors, { commentCost: newComment.cost || 0 })
...
function updateAncestorsCommentCount (cache, ancestors, { ncomments = 1, nDirectComments = 1, commentCost = 0 } = {}) {
