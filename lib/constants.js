...
// attached wallets
export const WALLET_TYPE_LNADDR = 'LIGHTNING_ADDRESS'
export const WALLET_TYPE_LND = 'LND'
export const WALLET_TYPE_CLN = 'CLN'
export const WALLET_FIELD_LNADDR = 'walletLightningAddress'
export const WALLET_FIELD_LND = 'walletLND'
export const WALLET_FIELD_CLN = 'walletCLN'
const WALLET_TYPES = [WALLET_TYPE_LNADDR, WALLET_TYPE_LND, WALLET_TYPE_CLN]
const WALLET_FIELDS = [WALLET_FIELD_LNADDR, WALLET_FIELD_LND, WALLET_FIELD_CLN]

export const walletTypeToField = (walletType) => {
  switch (walletType) {
    case WALLET_TYPE_LND:
      return WALLET_FIELD_LND
    case WALLET_TYPE_CLN:
      return WALLET_FIELD_CLN
    case WALLET_TYPE_LNADDR:
      return WALLET_FIELD_LNADDR
    default:
      throw new Error('unknown wallet type')
  }
}

export const WALLET_LOG_TAG_LNADDR = 'lnAddr'
export const WALLET_LOG_TAG_LND = 'lnd'
export const WALLET_LOG_TAG_CLN = 'cln'
export const WALLET_LOG_TAG_NWC = 'nwc'
export const WALLET_LOG_TAG_LNBITS = 'lnbits'
export const WALLET_LOG_TAGS_SERVER = [WALLET_LOG_TAG_LNADDR, WALLET_LOG_TAG_LND, WALLET_LOG_TAG_CLN]
export const WALLET_LOG_TAGS_CLIENT = [WALLET_LOG_TAG_NWC, WALLET_LOG_TAG_LNBITS]

export const walletTypeToLogTag = (walletType) => {
  switch (walletType) {
    case WALLET_TYPE_LNADDR:
      return WALLET_LOG_TAG_LNADDR
    case WALLET_TYPE_LND:
      return WALLET_LOG_TAG_LND
    case WALLET_TYPE_CLN:
      return WALLET_LOG_TAG_CLN
  }
  throw new Error('unknown wallet type')
}

export const walletLogTagToType = (wallet) => {
  switch (wallet) {
    case WALLET_LOG_TAG_LNADDR:
      return WALLET_TYPE_LNADDR
    case WALLET_LOG_TAG_LND:
      return WALLET_TYPE_LND
    case WALLET_LOG_TAG_CLN:
      return WALLET_TYPE_CLN
  }
  throw new Error('cannot cast wallet log tag to type')
}

export const isServerWallet = (wallet) => {
  return WALLET_LOG_TAGS_SERVER.includes(wallet) || WALLET_TYPES.includes(wallet) || WALLET_FIELDS.includes(wallet)
}
