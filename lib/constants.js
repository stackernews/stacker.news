...
export const ITEM_TYPES_USER = ['all', 'posts', 'comments', 'bounties', 'events', 'links', 'discussions', 'polls', 'freebies', 'jobs', 'bookmarks']
export const ITEM_TYPES = ['all', 'posts', 'comments', 'bounties', 'events', 'links', 'discussions', 'polls', 'freebies', 'bios', 'jobs']
