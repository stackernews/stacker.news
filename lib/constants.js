...
export const SN_ADMIN_IDS = [USER_ID.k00b, USER_ID.ek, USER_ID.sox, USER_ID.soxme, USER_ID.sn]
...
// batch migration config
export const BATCH_MAX_ITEMS_PER_JOB = 10000
export const BATCH_DELAY_MS = 1000
export const BATCH_SIZE = 100
export const BATCH_MAX_CONCURRENT = 5
