...
// auth sync
export const SYNC_TOKEN_MAX_AGE = 60 * 5 // 5 minutes
export const VERIFICATION_TOKEN_EXPIRY = 1000 * 60 * 5 // 5 minutes in milliseconds
export const AUTH_SYNC_TOKEN_TAG = 'auth-sync'
