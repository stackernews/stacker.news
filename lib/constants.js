...
export const PAY_IN_NOTIFICATION_TYPES = ['ITEM_CREATE', 'ZAP', 'DOWN_ZAP', 'BOOST']
...
// Higher filter threshold for homepage (null sub) hot/top feeds
...
// rankhot exponential decay parameter (in seconds)
// sigma = 4 hours (14400s), matching the old ln(2)/4-hour doubling time
// half-life ≈ sigma * ln(2) ≈ 2.77 hours
export const RANK_HOT_SIGMA = 14400
