...
// coerce to Number first: msatsToSatsDecimal (and other callers) can pass a numeric string like
// "1.000", and numWithUnits' singular check (n === 1) is strict, so an un-coerced string always pluralizes
export const formatSats = (sats) => numWithUnits(Number(sats), { unitSingular: 'sat', unitPlural: 'sats', abbreviate: false })
