...
exports.numWithUnits = (n, {
  ...
  return `${abbreviate ? exports.abbrNum(n) : n} ${n === 1 ? unitSingular : unitPlural}`
}

exports.fixedDecimal = (n, f) => {
  return Number.parseFloat(n).toFixed(f)
}

exports.msatsToSats = msats => {
...
exports.msatsToSatsDecimal = msats => {
  if (msats === null || msats === undefined) {
    return null
  }
  return exports.fixedDecimal(Number(msats) / 1000.0, 3)
}
