...
import { $getEditor, $isRootOrShadowRoot, $getSelection, $createRangeSelection, $setSelection, $isRangeSelection } from 'lexical'

/**
 * checks if the editor is in markdown mode by checking the editor namespace
 *
 * if no editor is provided, this function must be called inside a read/update transaction
 *
...
export function isMarkdownMode (editor) {
  ...
  const namespace = currentEditor._config.namespace
