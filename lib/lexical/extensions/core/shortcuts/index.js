...
/**
 * normalizes keyboard event keys across different input methods
 * @param {KeyboardEvent} e - keyboard event
 * @returns {string} normalized lowercase key string
 */
...
/**
 * parses keyboard shortcut combo strings (e.g., "mod+b")
 * @param {string} combo - shortcut combo string with modifiers and key
 * @returns {Object} object with mask (modifier keys) and key properties
 */
...
/**
 * checks if a keyboard event matches a shortcut combo
 * @param {KeyboardEvent} e - keyboard event to check
 * @param {string|string[]} combo - shortcut combo string or array of combos
 * @returns {boolean} true if event matches any of the combos
 */
...
export const ShortcutsExtension = defineExtension({
  ...
  config: { shortcuts: getAllShortcuts() },
