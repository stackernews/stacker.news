...
import { $debugNodeToJSON } from '@/lib/lexical/utils'
...
export function exportLexicalTreeToMdast ({
  ...
  process.env.NODE_ENV !== 'production' && console.log('[Lexical->MDAST] MDAST tree result', JSON.stringify(unistRoot, null, 2))
