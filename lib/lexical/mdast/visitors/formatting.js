import { $createTextNode, $createParagraphNode, $isParagraphNode } from 'lexical'
import {
  IS_BOLD,
  IS_CODE,
  IS_HIGHLIGHT,
...
export const MdastHtmlFallbackVisitor = {
  ...
  visitNode ({ mdastNode, lexicalParent, actions }) {
    ...
    // if parent is not a paragraph, wrap in paragraph before appending
    if (!$isParagraphNode(lexicalParent)) {
