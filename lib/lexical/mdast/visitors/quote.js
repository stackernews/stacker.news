...
// lexical -> mdast
// Lexical quotes hold inline children (text, links, line breaks) directly
// mdast blockquotes expect content wrapped in paragraph nodes,
// so we walk the children and start a new paragraph on each line break.
