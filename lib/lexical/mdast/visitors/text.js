...
export const MdastTextVisitor = {
  testNode: 'text',
  visitNode ({ mdastNode, lexicalParent, actions, transformerBridge = false }) {
    ...
    if (transformerBridge) {
      // transformer bridge mode: create separate paragraph nodes for each part
