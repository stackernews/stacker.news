...
import { batchedCheckMedia } from '@/lib/lexical/exts/media-check'
import { UNKNOWN_LINK_REL } from '@/lib/constants'

/** checks media nodes in batches
 * @param {Object} editor - lexical editor instance
 * @returns {Promise<boolean>} true if nodes were updated, false otherwise
 */
export async function ssrCheckMediaNodes (editor) {
  ...
  if (updated) {
    console.log('media nodes updated:', keys)
  }
  return updated
}
