...
import SpoilerIcon from '@/svgs/eye-close-line.svg'
...
import HighlightIcon from '@/svgs/lexical/highlighter.svg'
...
export const INLINE_ICONS = {
  ...
  highlight: { default: HighlightIcon }
}
...
/**
 * returns icon component for a given ID and state
 * @param {string} id - icon identifier
 * @param {string} [state='default'] - icon state ('default', 'active', etc.)
 * @returns {Object|null} icon component or null if not found
 */
