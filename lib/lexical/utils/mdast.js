  ...
  const markdown = exportMarkdownFromLexical({
    ...
    toMarkdownOptions: {
      ...
      handlers: {
        ...
        // XXX: stuff like "# text" in rich mode won't be escaped into "\# text" when converting to markdown,
        // and instead it will create a heading. this is bad because if the user wanted an heading, there would be an HeadingNode.
