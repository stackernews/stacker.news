...
export async function crosspostDiscussion(item, id) {
  console.log('Crossposting discussion:', item, id);
  ...
  try {
    ...
    // Update with relays from user settings
    const relays = ['wss://nostr.mutinywallet.com', 'wss://nostrue.com', 'wss://relay.nostr.band']
