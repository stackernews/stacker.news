...
export function patchDOMTranslations () {
  ...
  Node.prototype.removeChild = function (child) {
    if (child && child.parentNode !== this) {
      if (translateActive) {
        console.log('translate, removeChild', child)
        return child
      }
      console.log('no translate, removeChild', child)
    }
  ...
  Node.prototype.insertBefore = function (newNode, referenceNode) {
    if (referenceNode && referenceNode.parentNode !== this) {
      if (translateActive) {
        console.log('translate, insertBefore', newNode, referenceNode)
        return newNode
      }
      console.log('no translate, insertBefore', newNode, referenceNode)
    }
