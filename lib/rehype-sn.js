...
import { assembleDetails } from './rehype-sn-prepass'
...
export default function rehypeSN (options = {}) {
  ...
  return function transformer (tree) {
    try {
      // Pre-pass: assemble <details>/<summary> from raw HTML markers across siblings
      assembleDetails(tree)
  ...
  // Assemble <details>/<summary> blocks from raw tags across sibling nodes, with nesting support
