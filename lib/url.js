...
export const AUTOLINK_URL_REGEXP = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)(?<![-.+():%])/
export const EMAIL_REGEXP = /(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/
export const SN_ITEM_URL_REGEXP = new RegExp(`${process.env.NEXT_PUBLIC_URL}/items/\\d+[a-zA-Z0-9/?=]*`, 'i')
...
export const VIDEO_URL_REGEXP = /^(https?:\/\/.*\.(?:mp4|webm|ogg|mov|avi|wmv|flv|m4v|m4a|aac|mp3|wav|ogg|webm))$/
