...
// eslint-disable-next-line
export const FIND_URLS_REGEXP = /https?:\/\/[^\s/$.?#].[^\s]*/gi;

export function findUniqueUrls (text) {
  const urls = [...text.matchAll(FIND_URLS_REGEXP)].map(match => match[0])
