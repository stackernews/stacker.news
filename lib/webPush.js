...
export async function notifyCured (userId) {
  try {
    await sendUserNotification(userId, {
      title: 'your infection was cured by a mysterious stranger',
      body: 'You feel better, but the desire to zap has not gone away ...'
    })
  } catch (err) {
    log('error sending cured notification:', err)
  }
}
