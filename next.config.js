  ...
  webpack: (config, { isServer, dev, defaultLoaders }) => {
    if (isServer) {
      const workboxPlugin = new InjectManifest({
        include: [/\/(icons|maskable|splash)\//, /\.webp$/],
        // TODO: somehow also include these chunks but this doesn't work
        // it requires a string instead of a regexp but I don't know the name of the chunk in advance ...
        // probably need to figure out how to generate named chunks
        // chunks: [/(main|framework|_app)-[a-f0-9]{16}\.js$/],
        swDest: '../../public/sw.js',
        swSrc: './sw/index.js',
