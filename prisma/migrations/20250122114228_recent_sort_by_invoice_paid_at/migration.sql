...
-- select COALESCE("invoicePaidAt", created_at) for comments, too
...
BEGIN
    ...
    EXECUTE 'CREATE TEMP TABLE IF NOT EXISTS t_item ON COMMIT DROP AS'
        || '    SELECT "Item".*, COALESCE("Item"."invoicePaidAt", "Item".created_at) at time zone ''UTC'' AS "createdAt", "Item".updated_at at time zone ''UTC'' AS "updatedAt", '
