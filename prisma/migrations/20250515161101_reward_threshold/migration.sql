...
BEGIN
    ...
    LATERAL
        ...
        upvoter_ratios AS (
            SELECT "userId", sum((2*early_multiplier+1)*tipped_ratio*ratio*handicap_mult) as upvoter_ratio,
            ...
            FROM (
                SELECT *,
                    ...
                    CASE WHEN upvoters."userId" = ANY(handicap_ids) THEN handicap_zap_mult ELSE 1 END as handicap_mult
                FROM upvoters
                WHERE tipped > 0
            ) u
