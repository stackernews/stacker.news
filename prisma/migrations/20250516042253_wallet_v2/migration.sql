...
BEGIN
    ...
    LOOP
        ...
        BEGIN
            ...
            IF row."adminKeyId" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, true, 'LNBITS');
            ...
            IF row."invoiceKey" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'LNBITS');
    ...
    LOOP
        ...
        BEGIN
            ...
            IF row."primaryPasswordId" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, true, 'PHOENIXD');
            ...
            IF row."secondaryPassword" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'PHOENIXD');
    ...
    LOOP
        ...
        BEGIN
            ...
            IF row."apiKeyId" IS NOT NULL AND row."currencyId" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, true, 'BLINK');
            ...
            IF row."apiKeyRecv" IS NOT NULL AND row."currencyRecv" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'BLINK');
    ...
    LOOP
        ...
        BEGIN
            ...
            protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'LND_GRPC');
    ...
    LOOP
        ...
        BEGIN
            ...
            protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, true, 'LNC');
    ...
    LOOP
        ...
        BEGIN
            ...
            protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'CLN_REST');
    ...
    LOOP
        ...
        BEGIN
            ...
            IF row."nwcUrlRecv" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'NWC');
                INSERT INTO "WalletRecvNWC" ("walletId", "url")
                VALUES (protocolWalletId, row."nwcUrlRecv");
            END IF;

            IF row."nwcUrlId" IS NOT NULL THEN
                protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, true, 'NWC');
    ...
    LOOP
        ...
        BEGIN
            ...
            protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, false, 'LN_ADDR');
    ...
    LOOP
        ...
        BEGIN
            ...
            protocolWalletId := create_protocol_wallet(row."walletId", userWalletId, true, 'WEBLN');
...
DROP FUNCTION create_protocol_wallet(INT, INT, BOOLEAN, "WalletProtocol");
