...
-- CreateIndex
CREATE UNIQUE INDEX "WalletSendCLNRest_certVaultId_key" ON "WalletSendCLNRest"("certVaultId");
...
-- AddForeignKey
ALTER TABLE "WalletSendCLNRest" ADD CONSTRAINT "WalletSendCLNRest_certVaultId_fkey" FOREIGN KEY ("certVaultId") REFERENCES "Vault"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
