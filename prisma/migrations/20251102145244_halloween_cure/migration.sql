...
-- CreateIndex
CREATE INDEX "Cure_curerId_index" ON "Cure"("curerId");
...
-- AddForeignKey
ALTER TABLE "Cure" ADD CONSTRAINT "Cure_curerId_fkey" FOREIGN KEY ("curerId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Cure" ADD CONSTRAINT "Cure_itemActId_fkey" FOREIGN KEY ("itemActId") REFERENCES "ItemAct"("id") ON DELETE SET NULL ON UPDATE CASCADE;
