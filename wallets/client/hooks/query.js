...
// a mutation that does nothing as a placeholder
...
function getWalletProtocolUpsertMutation (protocol) {
  switch (protocol.name) {
    ...
    case 'LND_GRPC':
      return protocol.send ? NOOP_MUTATION : UPSERT_WALLET_RECEIVE_LNDGRPC
    case 'LNC':
...
function getWalletProtocolTestMutation (protocol) {
  ...
  switch (protocol.name) {
    ...
    case 'LNDGRPC':
      return TEST_WALLET_RECEIVE_LNDGRPC
    default:
      return NOOP_MUTATION
  }
}
